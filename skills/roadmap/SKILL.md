...
Item prose follows `artifact_language` — the `## Shipped` heading and the table structure stay English (downstream skills parse them) → [`../_shared/artifact-language.md`](../_shared/artifact-language.md).
